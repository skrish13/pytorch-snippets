...
- [Trainer module and plugin utils](https://github.com/pytorch/tnt)
- [Ready to use -> Diff weight inits](https://github.com/skrish13/pytorch-snippets/blob/master/pytorch-weight-inits.py)
